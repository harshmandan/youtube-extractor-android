package com.mbytessolution.youtube_extractor;
...
import com.mbytessolution.youtube_extractor.StreamExtractor.ExtractorException;
...
public class YoutubeExtractor  {
    ...
    public void Extract(String Url, String ExtractorType, YoutubeExtractorCallback callback) {
      ...
      if (ExtractorType.equalsIgnoreCase("StreamExtractor")) {
          try {
              new com.mbytessolution.youtube_extractor.StreamExtractor.YoutubeStreamExtractor(new com.mbytessolution.youtube_extractor.StreamExtractor.YoutubeStreamExtractor.ExtractorListner() {
                  @Override
